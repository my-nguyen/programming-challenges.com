...
bool input(char* input_file, Board* list[], int& count)
{
    bool success;
...
void output(Board* boards[], int count)
{
    if (_debug >= DEBUG_COPIOUS)
        cout << "PROCESSING " << count << " boards" << endl;
